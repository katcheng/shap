...
def draw_labels(fig, ax, out_value, features, feature_type, offset_text, total_effect=0, min_perc=0.05, text_rotation=0, font_size=13):
    ...
    for feature in features:
        ...
        # print("changes in package registered.")
...
def draw_output_element(out_name, out_value, ax, font_size=14):
    # Add output value
...
def draw_base_element(base_value, ax, font_size=12):
...
def draw_higher_lower_element(out_value, offset_text, font_size=13):
...
def draw_additive_plot(data, figsize, show, text_rotation=0, min_perc=0.05, font_size=25):
    """Draw additive plot."""
    # Turn off interactive plot
    # print("in draw additive plot")
    if show is False:
        plt.ioff()
    ...
    fig, ax = draw_labels(fig, ax, out_value, neg_features, 'negative',
                         offset_text, total_effect, min_perc=min_perc, text_rotation=text_rotation, font_size=20)
    
    fig, ax = draw_labels(fig, ax, out_value, pos_features, 'positive',
                         offset_text, total_effect, min_perc=min_perc, text_rotation=text_rotation, font_size=20)
    
    # higher lower legend
    draw_higher_lower_element(out_value, offset_text, font_size)
    
    # Add label for base value
    draw_base_element(base_value, ax, font_size)
    
    # Add output label
    out_names = data['outNames'][0]
    draw_output_element(out_names, out_value, ax, font_size)
